...
`HSCraftSim` is developed as a submodule of the
...
- **This module's guide:** [`../docs/submodules/HSCraftSim/instructions.md`](../docs/submodules/HSCraftSim/instructions.md) —
  [view on GitHub](https://github.com/falorfrozen-cmd/hero-siege-offline-toolkit/blob/main/docs/submodules/HSCraftSim/instructions.md)
